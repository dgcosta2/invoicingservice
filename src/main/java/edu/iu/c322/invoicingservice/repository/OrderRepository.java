...
//        items.add(new Item(1, "Tea", 24.84));
//        items.add(new Item(2, "Turmeric Paste", 22.99));
//        Address orderAddress = new Address("Indiana", "Bloomington", 47408);
//        Address billingAddress = new Address("Indiana", "Bloomington", 47408);
//        Payment payment = new Payment("Discover", "12345678", billingAddress);
//        InvoiceItem invoiceItem = new InvoiceItem();
//        invoiceItem.setItems(items);
//        invoiceItem.setAddress(orderAddress);
//        invoiceItem.setOn("3/5/2023");
//        invoiceItem.setStatus("shipping now");
//        invoiceItems.add(invoiceItem);
//        Invoice invoice = new Invoice();
//        invoice.setInvoiceItem(invoiceItems);
//        invoice.setOrderPlaced("3/4/2023");
//        invoice.setTotal(60.26);
...
//    }
    ...
    public Invoice getInvoiceByOrderId(int id) {
        Order o = getByOrderId(id);
        if (o != null) {
            InvoiceItem invoiceItem = new InvoiceItem(o.getStatus(), o.getItems(), "3/5/2023", o.getShippingAddress());
            Invoice invoice = new Invoice();
            invoice.setInvoiceItem(new ArrayList<>());
            invoice.getInvoiceItem().add(invoiceItem);
            invoice.setOrderId(o.getId());
            invoice.setOrderPlaced(o.getOrderPlaced());
            invoice.setTotal(o.getTotal());
            invoice.setPayment(o.getPayment());
            invoice.setTotal(o.getTotal());
            return invoice;
        } else {
    ...
    public void updateShippingStatus(UpdateRequest updateRequest, int orderId) {
        Order o = getByOrderId(orderId);
        if (o != null) {
